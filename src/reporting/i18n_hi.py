...
HI: dict[str, str] = {
    ...
    **NOISE_LABEL,
    ...
    "Manual import (agency sites, other portals)": "मैन्युअल आयात (एजेंसी साइटें, अन्य पोर्टल)",
    # ---- utilities
    "water": "पानी", "electricity": "बिजली", "gas": "गैस", "internet": "इंटरनेट", "cable TV": "केबल टीवी",
    "utilities": "सेवाएँ", "municipal fees": "नगरपालिका शुल्क",
